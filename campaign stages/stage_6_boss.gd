...
func _ready() -> void:
	...
	display_names["bandit"] = "Angron" # <--- CHANGE THIS to whatever you want displayed
...
# Show initial tutorial dialogue
	...
	# generate_new_problem()
	AudioManager.change_music("regboss")
...
func show_tutorial_dialogue() -> void:
	...
	current_dialogue = [
		{"name": "", "text": "(Night fell over the Grunwald. The forest was still... almost too still.)"},
		{"name": "", "text": "(After hours of fighting off goblins, Alric and Mathie finally stopped to rest.)"},
		{"name": "", "text": "(They set up camp in a small clearing, hoping for a quiet night.)"},
		{"name": "", "text": "(But peace never lasts long in a cursed forest.)"},
		{"name": "", "text": "*Thud.*"},
		{"name": "", "text": "*Thud... Thud...*"},
		{"name": "Buddy", "text": "...Alric, wake up."},
		{"name": "Teacher", "text": "Mmnh... What is it—"},
		{"name": "", "text": "*THUD!* The ground shakes. The trees creak and groan."},
		{"name": "Buddy", "text": "Something’s coming. Something big."},
		{"name": "", "text": "(They grab their gear and step out into the cold night air.)"},
		{"name": "", "text": "In the distance, red light flickers between the trees..."},
		{"name": "", "text": "Then, a monstrous figure steps from the shadows—horns, armor, and burning eyes."},
		{"name": "Teacher", "text": "Who are you?!"},
		{"name": "bandit", "text": "I am Angron!"},
		{"name": "bandit", "text": "So... the little heroes have wandered into *my* woods."},
		{"name": "Buddy", "text": "That’s... him. The one who’s been commanding the goblins."},
		{"name": "Teacher", "text": "And he’s holding it... Multiplication!"},	
		{"name": "bandit", "text": "You’re looking for this? Lol, Come and get it."},
		{"name": "bandit", "text": "This power belongs to me! With it, I’ll multiply my wrath a hundredfold!"},
		{"name": "Buddy", "text": "We won’t let you use it to spread destruction."},
		{"name": "Teacher", "text": "This ends here!"},
		{"name": "bandit", "text": "So be it."},
		{"name": "bandit", "text": "Blood for the blood god..."},
		{"name": "bandit", "text": "Skull for the skull throne!"}
]
...
func show_time_up_dialogue():
	...
	current_dialogue = [
		{"name": "Buddy", "text": "Hey! Wake Up!"},
		{"name": "Buddy", "text": "Our lives is on the line bud!"}
		# Or just one speaker:
...
func show_end_stage_dialogue() -> void:
	...
	if player_won:
		current_dialogue = [
			{"name": "bandit", "text": "oof"},
			{"name": "", "text": "(Angron, the red demon vanished into the mist.)"},
			{"name": "", "text": "(Multiplication drops on the ground.)"},
			{"name": "Teacher", "text": "Take that!"},
			...
			{"name": "Buddy", "text": "According to my map, there is a town nearby."},
			{"name": "Buddy", "text": "We should stop by there to take a rest and resupply."},
			{"name": "Teacher", "text": "Sounds Good."},
			{"name": "Teacher", "text": "Let's Go!, I'll lead the way."},
		]
	else:
		current_dialogue = [
