...
func show_tutorial_dialogue() -> void:
	...
	current_dialogue = [
		...
		{"name": "", "text": "(Wounded and weary, they headed toward the nearest village to rest and resupply.)"},
		...
		{"name": "", "text": "(As they approached the village gates, they noticed something strange...)"},
		{"name": "", "text": "(The village was silent.)"},
		...
		{"name": "Teacher", "text": "Are you the village militia? What happened to this place?"},
		...
		{"name": "Rebkn", "text": "This village no longer recognizes King Eldrin. Get Lost."},
...
func show_end_stage_dialogue() -> void:
	...
	if player_won:
		current_dialogue = [
			...
			{"name": "Teacher", "text": "So it says here, The Lord of this village, Countess Alatea..."},
...
# Save for UI
	...
	if player_won:
		PlayerData.complete_stage(7)  # or 19 or current stage ID
